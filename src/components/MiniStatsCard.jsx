...
import { C, FD, FM } from "../constants";

export function MiniStatsCard({ trades, balance }) {
  ...
  return (
    <div className="slide-down" style={{
      ...
      {[
        ...
        <div key={s.l} style={{ textAlign: "center", ...(i < 4 ? { paddingRight: "14px", borderRight: `1px solid ${C.border}` } : {}) }}>
